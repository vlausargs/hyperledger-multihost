...
ORG=org1
CA_PORT="${ORG1_CA_PORT}"
TLSCA_PORT="${ORG1_TLSCA_PORT}"
CA_NAME="ca-org1"
...
register_idempotent "${CA_NAME}" "${CA_TLS_CERT}" "org1admin"  "org1adminpw"  "admin"
...
# Org admin MSP
# -----------------------------
echo "==> Enroll Org1 Admin MSP"
fabric-ca-client enroll \
  -u "https://org1admin:org1adminpw@localhost:${CA_PORT}" \
  --caname "${CA_NAME}" \
